...
/**
 * Class containing the main method. It is mainly responsible for parsing the input arguments and starting the MyMiddleware class with the corresponding params.
 */
public class RunMW {
